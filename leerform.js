function leer(){
	...
	document.getElementById("resultado").innerHTML="Tu nombre es: "+nom+"\<br>Tu password es: "+clave+"\<br>Tu carrera es: "+carrera1+"\<br>Tu género es: "+g+"\<br>Aceptación de los acuerdos: "+ok;
}